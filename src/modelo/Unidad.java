...
public class Unidad  implements java.io.Serializable {
    ...
    public Unidad(int idUnidad, String block, Integer torre, Integer puerta, String nombre, String apellido, String telefono, String mail, Boolean propietarioInquilino, Date fechaIngreso, Boolean activo, Set convenios, Set otrosgastoses, Set gastoscomuneses, Set notacreditos) {
       this.idUnidad = idUnidad;
       this.block = block;
       this.torre = torre;
       this.puerta = puerta;
